...
cdef DTYPE_t two_boxes_iou(np.ndarray[DTYPE_t, ndim=1] rectangle_1, np.ndarray[DTYPE_t, ndim=1] rectangle_2):
    ...
    rect_1 = ((rectangle_1[0], rectangle_1[1]), (rectangle_1[2], rectangle_1[3]), rectangle_1[-1])
    rect_2 = ((rectangle_2[0], rectangle_2[1]), (rectangle_2[2], rectangle_2[3]), rectangle_2[-1])

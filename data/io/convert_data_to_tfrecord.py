...
tf.app.flags.DEFINE_string('VOC_dir', '/mnt/ExtraDisk/yangxue/data_ship_clean/VOCdevkit_test/', 'Voc dir')
...
tf.app.flags.DEFINE_string('save_dir', cfgs.ROO_PATH + '/data/tfrecord/', 'save name')
